...
import admin.example.ungdungsuckhoethongminh.adapters.CalosPagerAdapter;

public class CaloActivity  extends AppCompatActivity {
    TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calos);
        ...
        viewPager.setAdapter(new CalosPagerAdapter(this));
