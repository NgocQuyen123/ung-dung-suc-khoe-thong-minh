...
public class RecoveryArcView extends View {

    private Paint arcPaint;
    private Paint bgPaint;
    private int progress = 39;

    public RecoveryArcView(Context context) {
        super(context);
        init();
    }

    public RecoveryArcView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RecoveryArcView(Context context, AttributeSet attrs, int defStyleAttr) {
