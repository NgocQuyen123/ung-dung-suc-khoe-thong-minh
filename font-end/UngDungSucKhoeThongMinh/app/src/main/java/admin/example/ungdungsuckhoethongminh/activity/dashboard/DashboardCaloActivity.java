...
import admin.example.ungdungsuckhoethongminh.adapters.CaloPagerAdapter;

public class DashboardCaloActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_calo);
        ...
        viewPager.setAdapter(new CaloPagerAdapter(this));
